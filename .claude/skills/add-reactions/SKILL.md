...
This skill adds emoji reaction support to Breadbrich Engels's WhatsApp channel: receive and store reactions, send reactions from the container agent via MCP tool, and query reaction history from SQLite.
...
- Check Breadbrich Engels logs for `Failed to process reaction` errors
