---
name: add-discord
description: Add Discord bot channel integration to Breadbrich Engels.
---

# Add Discord Channel

This skill adds Discord support to Breadbrich Engels, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/qwibitai/salem-discord.git
```
...
> 2. Click **New Application** and give it a name (e.g., "Breadbrich Engels Assistant")
...
4. Service is running: `launchctl list | grep breadbrich`
...
- @mention translation (Discord `<@botId>` → Breadbrich Engels trigger format)
