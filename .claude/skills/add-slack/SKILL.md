...
This skill adds Slack support to Breadbrich Engels, then walks through interactive setup.
...
>
> The JID format for Breadbrich Engels is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.breadbrich`
