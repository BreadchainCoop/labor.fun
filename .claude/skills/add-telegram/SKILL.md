...
This skill adds Telegram support to Breadbrich Engels, then walks through interactive setup.
...
```bash
git remote add telegram https://github.com/qwibitai/salem-telegram.git
```
...
>    - Bot name: Something friendly (e.g., "Breadbrich Engels Assistant")
...
> - For non-main: `@Breadbrich Engels hello` or @mention the bot
>
...
- Check bot is started: `tail -f logs/breadbrich.log`
