...
//
// An independent reimplementation of the Things mechanism designed by Daniel
...
//
// DEFERRED (choreWheel features not implemented here): vote anonymization,
// per-account multi-fund support (single "general" account unless buys
// specify another), fulfillment statistics.
