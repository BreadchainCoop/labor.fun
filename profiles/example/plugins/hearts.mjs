...
//
// An independent reimplementation of the Hearts mechanism designed by Daniel
// Kronovet for choreWheel (https://github.com/zaratanDotWorld/choreWheel,
// AGPL-3.0). The mechanism design and its parameters are ported onto the
// labor.fun plugin surface (no choreWheel source code is copied — see
// NOTICE.md), following the exact patterns of chores.mjs:
...
//   * Karma: residents give karma with "<@user> ++" in chat. The house
//     agent records each karma grant as a file. Shortly after month start
...
//     short. (Upstream calculatePenalty; this plugin assumes a full-month
//     obligation, no breaks/working-percentage.)
//
...
//
// DEFERRED (choreWheel features not implemented here): resident
// retirement/deactivation at 0 hearts (announce-only), revives, vote
// anonymization, chore breaks/working-percentage proration, per-resident
// custom obligations.
