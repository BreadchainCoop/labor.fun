// chores.mjs — house chore wheel, as a labor.fun profile plugin.
//
// An independent reimplementation of the chores mechanism designed by Daniel
...
// NOTICE.md in this directory for attribution details. Zero framework-core
...
//     PowerRanker; this plugin uses explicit per-chore speed instead. See
//     DEFERRED.)
...
//
// DEFERRED (choreWheel features not implemented here): PowerRanker
//   preference-based priority ranking, special chores, breaks/working-ratio
//   proration, vote anonymization. (Hearts and Things are companion plugins:
//   hearts.mjs, things.mjs.)
