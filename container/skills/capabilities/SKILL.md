---
name: capabilities
description: Show what this Breadbrich Engels instance can do — installed skills, available tools, and system info. Read-only. Use when the user asks what the bot can do, what's installed, or runs /capabilities.
---

# /capabilities — System Capabilities Report

Generate a structured read-only report of what this Breadbrich Engels instance can do.
...
The Breadbrich Engels MCP server exposes these tools (via `mcp__nanoclaw__*` prefix):
...
```
📋 *Breadbrich Engels Capabilities*
