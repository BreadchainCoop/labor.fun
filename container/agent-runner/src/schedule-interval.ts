// MIRRORED FILE — keep in sync with src/schedule-interval.ts.
//
// container/agent-runner has its own tsconfig with "rootDir": "./src" and is
// built as a standalone package; it cannot import from ../../src. So the parser
// is duplicated verbatim here. Any change to one copy MUST be applied to the
// other, or the agent-facing validation and the scheduler will disagree about
